...
namespace eCinema.Infrastructure.Migrations
{
    ...
    [Migration("20230821165231_add-price")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eCinema.Core.ShowSeat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eCinema.Core.Reservation", b =>
                {
                    b.HasOne("eCinema.Core.Seat", null)
                        .WithMany("Reservations")
                        .HasForeignKey("SeatId");

                    b.HasOne("eCinema.Core.Show", null)
                        .WithMany("Reservations")
                        .HasForeignKey("ShowId");

                    b.HasOne("eCinema.Core.ShowSeat", "ShowSeat")
                        .WithMany("Reservations")
