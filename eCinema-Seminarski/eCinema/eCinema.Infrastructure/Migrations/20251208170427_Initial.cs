    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(1965, 4, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 12, 8, 17, 4, 27, 28, DateTimeKind.Utc).AddTicks(5945), "robert.downeyjr@example.com", "Robert", 0, "Downey Jr.", null },
                    { 2, new DateTime(1984, 11, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 12, 8, 17, 4, 27, 28, DateTimeKind.Utc).AddTicks(5945), "scarlett.johansson@example.com", "Scarlett", 1, "Johansson", null },
                    { 3, new DateTime(1981, 6, 13, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 12, 8, 17, 4, 27, 28, DateTimeKind.Utc).AddTicks(5945), "chris.evans@example.com", "Chris", 0, "Evans", null },
                    { 4, new DateTime(1981, 6, 9, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 12, 8, 17, 4, 27, 28, DateTimeKind.Utc).AddTicks(5945), "natalie.portman@example.com", "Natalie", 1, "Portman", null },
                    { 5, new DateTime(1996, 6, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 12, 8, 17, 4, 27, 28, DateTimeKind.Utc).AddTicks(5945), "tom.holland@example.com", "Tom", 0, "Holland", null },
                    { 6, new DateTime(1990, 4, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 12, 8, 17, 4, 27, 28, DateTimeKind.Utc).AddTicks(5945), "emma.watson@example.com", "Emma", 1, "Watson", null },
                    { 7, new DateTime(1974, 11, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 12, 8, 17, 4, 27, 28, DateTimeKind.Utc).AddTicks(5945), "leonardo.dicaprio@example.com", "Leonardo", 0, "DiCaprio", null },
                    { 8, new DateTime(1990, 8, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 12, 8, 17, 4, 27, 28, DateTimeKind.Utc).AddTicks(5945), "jennifer.lawrence@example.com", "Jennifer", 1, "Lawrence", null },
                    { 9, new DateTime(1937, 6, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 12, 8, 17, 4, 27, 28, DateTimeKind.Utc).AddTicks(5945), "morgan.freeman@example.com", "Morgan", 0, "Freeman", null },
                    { 10, new DateTime(1975, 6, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 12, 8, 17, 4, 27, 28, DateTimeKind.Utc).AddTicks(5945), "angelina.jolie@example.com", "Angelina", 1, "Jolie", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2025, 12, 8, 17, 4, 27, 28, DateTimeKind.Utc).AddTicks(6316), new DateTime(2025, 12, 29, 10, 0, 0, 0, DateTimeKind.Unspecified), null, 1, 10.0, null, 1, new DateTime(2025, 12, 29, 8, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 2, 1, new DateTime(2025, 12, 8, 17, 4, 27, 28, DateTimeKind.Utc).AddTicks(6316), new DateTime(2025, 12, 30, 10, 0, 0, 0, DateTimeKind.Unspecified), null, 1, 12.0, null, 1, new DateTime(2025, 12, 30, 8, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 3, 1, new DateTime(2025, 12, 8, 17, 4, 27, 28, DateTimeKind.Utc).AddTicks(6316), new DateTime(2025, 12, 31, 10, 0, 0, 0, DateTimeKind.Unspecified), null, 1, 15.0, null, 1, new DateTime(2025, 12, 31, 8, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 4, 1, new DateTime(2025, 12, 8, 17, 4, 27, 28, DateTimeKind.Utc).AddTicks(6316), new DateTime(2026, 1, 5, 10, 0, 0, 0, DateTimeKind.Unspecified), null, 1, 20.0, null, 1, new DateTime(2026, 1, 5, 8, 0, 0, 0, DateTimeKind.Unspecified) }
                });
